...
const UNAVAILABLE_USERNAME_MESSAGE =
  'The chosen username is unavailable, please choose another';
const UNAUTHORIZED_MESSAGE = 'The username or password is incorrect';
  ...
  async getBalance(authorization: string | undefined): Promise<number> {
    ...
    if (!user || !account)
      throw new NotFoundError(
        'User or account could not be found.'
      );
